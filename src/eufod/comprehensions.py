"""List-comprehension implementation of the same R-factor search."""
...
def solve(exp_delta, oxygen, hydrogens, offset=300, step=5):
    """Search the grid using comprehensions where practical."""
    ...
    for eu in candidates:
        ...
        if eu_oxygen < MIN_DISTANCE or any(d < MIN_DISTANCE for d in eu_h):
            continue
